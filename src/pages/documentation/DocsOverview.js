          ...
          <Card>
            <Card.Body>
              <article>
                ...
                <p>
                  Volt React Dashboard is a React.js and Bootstrap 5 powered
                  admin dashboard template featuring components, pages and
                  plugins that you can use to create an awesome and interactive
                  admin interface.
                </p>
                <p>
                  This product is built using the following widely used
                  technologies:
                </p>
                <ul className="docs-list">
                  <li>
                    Interactive UIs using{' '}
                    <Card.Link href="https://reactjs.org/" target="_blank">
                      React
                    </Card.Link>
                  </li>
                  <li>
                    Bootstrap 5 React Components based on{' '}
                    <Card.Link
                  ...
                  <li>
                    ...
                    <Card.Link href="https://getbootstrap.com/" target="_blank">
                      Bootstrap
                    </Card.Link>
                  </li>
                  <li>
